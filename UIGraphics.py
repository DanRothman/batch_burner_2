...
def setupUILayout(self,MainWindow):
	...
	#  
		...
		# self.scrollArea.setGeometry(QtCore.QRect(int(self.screenwidth*0.3), int(self.screenbaseheight*0.03), int(self.screenwidth*0.13), int(self.screenbaseheight*0.07)))
		# self.scrollArea.setWidgetResizable(True)
		# self.scrollArea.setObjectName("scrollArea")
		...
		# self.output_Box.setObjectName("output_rd")
		# self.scrollArea.setWidget(self.scrollAreaWidgetContents)
